...
| file-uploader | renderer         |  String  | fileuploader (this component does not integrate with Formik. Use the callback functions to implment an upload service. Validations are not supported.)                                                                                                                                                                                                                                            |
