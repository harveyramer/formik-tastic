...
|       | disabledText    |      String     | Shown if field is disabled (typically via enabledWhen)     |                                                                                                                                                                             |
...
| code-editor (disabled - out of date)   | renderer         |  String  | code-editor                                                                                                                                                                                                                                             |
|               | name             |  String  | html field name attribute                                                                                                                                                                                                                               |
|               | label            |  String  | the label for the field                                                                                                                                                                                                                                 |
|               | options          |    {}    |                                                                                                                                                                                                                                                         |
...
| file-uploader | renderer         |  String  | supports validations with Formik. Uploads must be managed by passing an onDrop handler in config.                                                                                                                                                                                                                                            |
|               | options          |    {}    | Options available in [react-dropzone plugin](https://react-dropzone.js.org/)                                                                                                                                                                            |
|               | zoneInactiveText   |  String  | Displayed in the drop zone when not active. Defaults to, "Drag and drop some files here, or click to select files"                                                                                                                                                                                 
|               | zoneActiveText   |  String  | Displayed in the drop zone when active. Defaults to, "Drop the files here ..."                                                                                                                                                                                                        |
